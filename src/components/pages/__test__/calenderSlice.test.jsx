import calanderReducer, {
  ...
  describe('calender reducer', () => {
    ...
    const availabeState = {
        dayStatus: [{day:0, status:0},{day:1, status:0}],
        calStatus: 'idle',
    };

    const availabeStateToOpen = {
        dayStatus: [{day:0, status:1},{day:1, status:1}],
        calStatus: 'idle',
    };

    it('should handle initial state', () => {
        const actual = calanderReducer(initialState, initializeCalendarStatus({userSelectedDay:10,maxDays:30}));
